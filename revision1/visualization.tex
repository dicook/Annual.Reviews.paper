...
\caption{Variations on parallel coordinates for categorical variables. If the ribbons peel off from the bars being initially flat (right side plot) provides for more accurate reading of the proportions in each category.}
\label{titanic}
\end{figure*}
