...
http://cran.r-project.org/web/packages/tabplot/index.html 
 ...
 is a R package for a visualization of a big data with various type of variables.
...
\item Rearranging and summarizing data {\tt ggplot2} / {\tt bigvis}
